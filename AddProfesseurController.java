 ...
 */
public class AddProfesseurController implements Initializable {
    ...
    @FXML
    private TextField specialiteTxt;
    @FXML
    ...
    private void save(MouseEvent event) {
        ...
        String specialite = specialiteTxt.getText();
        ...
        if(matricule.isEmpty()||prenom.isEmpty()||nom.isEmpty()||dateNaissance.isEmpty()||lieuNaissance.isEmpty()||genre.isEmpty()||
            nationalite.isEmpty()||adresse.isEmpty()||email.isEmpty()||telephone.isEmpty()||specialite.isEmpty()||situationMatrimoniale.isEmpty()){
    ...
    private void getQuery() {
        ...
        if(update == false){
            query = "INSERT INTO `professeur`(`matricule`, `prenom`, `nom`, `dateNaissance`, `lieuNaissance`, `genre`, `nationalite`, `adresse`, `email`, `telephone`, `specialite`, `situationMatrimoniale`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
        }else{
            query ="UPDATE `professeur` SET "
                    + "`matricule`=?,"
                    + "`prenom`=?,"
                    + "`nom`=?,"
                    + "`dateNaissance`=?,"
                    ...
                    + "`telephone`=?,"
                    + "`specialite`=?,"
                    + "`situationMatrimoniale`=? WHERE id= '"+professeurId+"'";
        }
    }
    ...
    private void insert() {
        ...
        try{
            ...
            preparedStatement.setString(11, specialiteTxt.getText());
    ...
    void setTextField(int id, String matricule, String prenom, String nom, LocalDate toLocalDate, String lieuNaissance, String genre, String nationalite, String adresse, String email, String telephone, String specialite, String situationMatrimoniale) {
        professeurId = id;
        ...
        specialiteTxt.setText(specialite);
